...
import SelectCategoryInputs from "@/components/SelectCategory";
...
export default function AddGifts() {
	...
	return (
		<KeyboardAwareScrollView style={tw`h-full bg-white`}>
			<ScrollView
				automaticallyAdjustKeyboardInsets={true}
				style={tw`h-full bg-white px-4`}
			>
				<View>
